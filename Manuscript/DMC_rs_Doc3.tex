...
%\end{subfigure}
%\caption{Figure 3A The Zero Point Energy (ZPE\textsubscript{T} trends lower as time step is decreased.\\
%Figure 3B: The standard deviation of the Zero Point Energy trends towards decreasing with an increase in a) timestep, b) walkers, c) production phases (10: solid line; 20: dashed line).}
%\end{figure}
...
%\end{subfigure}
%\caption{Figure 4A The Zero Point Energy (ZPE\textsubscript{T} trends lower as time step is decreased.\\
%Figure 4B: The standard deviation of the Zero Point Energy trends towards decreasing with an increase in a) timestep, b) walkers, c) production phases (10: solid line; 20: dashed line).}
%\end{figure}
