...
# ground state energy of a system of molecules. In this particular implementation, a 2D
...
# Initial 2D walker array
# Returns a uniform distribution cenetered at the given bond length
# Array axes are walkers and the atoms in each walker
walkers = np.random.rand(n_walkers, atomic_masses.shape[0]*coord_const) - .5
