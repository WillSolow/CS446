# Lindsey Madison (With updates from Will Solow)
# CS446 Fall 2020
# Diffusion Monte Carlo (DMC) Simulation
# Script Style
# Last Updated 11/13/20

# This code shows how to compute the intermolecular potential energy
# between two water molecules over many walkers which is in line
# with Prof Madison's intramolecular PE function
...
print('Potential Energy: ', PotentialEnergyManyWaters(test_walkers))