...
np.savetxt(f'{output_filename}_trimer_{method}_{prop_range}_ref.txt', ref_energy)
np.savetxt(f'{output_filename}_trimer_{method}_{prop_range}_walkers.txt', num_walkers)
