# TODO: code organization cf. DW stuff
...
# Length of the equilibriation phase in time steps. The equilibriation phase 
# should be at least 1 / sqrt(dt) * 1500, to ensure proper equilibriation given
...
# length of the equilibriation phase
sim_length = 1000
...
# Alternatively, load a 4D array of equilibriated walkers. Used in more complex
# systems where equilibriation takes a large amount of time due to that amount of
...
np.save('1000_water_single.npy', walkers)
