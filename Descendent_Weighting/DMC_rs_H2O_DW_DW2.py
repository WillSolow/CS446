...
# This file has been used to run descendent weighting on the .npy files outputted
# by the NSCC and then graphs the output
...
if len(sys.argv) < 6:
    print('\n\nUsage: DMC_rs_H2O_DW.py dt n_walkers prop_period prop_reps filename')
...
prop_period = int(sys.argv[3])
prop_reps = int(sys.argv[4])
